...
import { computeTechnicals, computeMomentumScore, buildSwingSetup, defaultAssumptions, computeDcf, signalFrom, type DcfAssumptions } from "./analysis";
import type { MarketData, TechnicalSignals, MomentumScore, DcfResult, SwingSetup } from "./types";
...
function hasCatalystDrift(data:MarketData){return(data.earnings[0]?.surprisePercent??0)>3}
