...
export default function Home() {
  ...
  return (
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="12.4" data-architecture="domain-workspaces" data-source-of-truth="portfolio-ledger">
      <header className="sentinel-topbar v11-topbar">
        <div className="sentinel-brand-lockup" aria-label="Sentinel Investment">
          ...
          <div className="sentinel-wordmark"><strong>SENTINEL</strong><strong>INVESTMENT OS</strong><span>Institutional Fund Operating System v12.4</span></div>
        </div>
      ...
      <div className="institutional-layout v11-layout">
        ...
        <div className="institutional-content">
          ...
          <main className="sentinel-main v11-main">
            ...
            {section === "command" && <CIOCommandCenterV12 lang={lang} onNavigate={navigate} />}
            {section === "portfolio" && <HoldingsDashboardV12 lang={lang} refreshKey={portfolioRefresh} onRefresh={refreshPortfolio} />}
      ...
      <footer className="footer-note v11-footer">Sentinel Investment OS v12.4 · Research → Stock Analysis → Holdings → CIO Committee · Human approval remains mandatory.</footer>
    </div>
  );
}
