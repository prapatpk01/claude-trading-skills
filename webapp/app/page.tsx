...
export default function Home() {
  ...
  return (
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="20.0" data-forecast-version="26.1" data-architecture="decision-execution-command-center" data-source-of-truth="portfolio-ledger">
