...
export default function Home(){
 ...
 return <div className="sentinel-shell" data-sentinel-version="10.2" data-governance="committee-state-machine">
  ...
  <div className="footer-note">{lang==="th"?<>Sentinel Investment OS v10.2 · Committee State Machine ภายใต้การกำกับของมนุษย์<br/>มติประชุมสร้าง Trade Ticket และบันทึก Ledger ได้ต่อเมื่อมนุษย์อนุมัติเท่านั้น</>:<>Sentinel Investment OS v10.2 · Committee State Machine with mandatory human oversight.<br/>Committee resolutions create trade tickets; ledger entries occur only after explicit human approval.</>}</div>
 </div>
}
