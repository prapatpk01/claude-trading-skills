    ...
    <div className="sentinel-shell">
      <header className="sentinel-topbar">
            ...
            <svg viewBox="0 0 72 78" role="img">
              <defs>
                <linearGradient id="sentinelWing" x1="8" y1="8" x2="65" y2="72" gradientUnits="userSpaceOnUse">
                  <stop offset="0" stopColor="#f2f3ff"/><stop offset="0.28" stopColor="#9fc7ff"/><stop offset="0.58" stopColor="#6f7cff"/><stop offset="0.82" stopColor="#9a52ff"/><stop offset="1" stopColor="#31d9f3"/>
                </linearGradient>
              </defs>
              <path d="M36 4 63 17 55 27 36 18 17 27 9 17 36 4Z" fill="url(#sentinelWing)" opacity=".96"/>
        ...
        <div className="sentinel-control-cluster">
          ...
          <div className="sentinel-confidence"><span>AI CONFIDENCE</span><span className="sentinel-confidence-bar"><span/></span><strong>87%</strong></div>
        </div>
      </header>

      <div className="sentinel-nav-wrap">
        <button className="btn ghost sm sentinel-lang-btn" type="button" onClick={() => setLang(lang === "en" ? "th" : "en")} aria-label="Toggle Thai English language">
      ...
      <div className="footer-note">
        {lang === "th" ? <>Sentinel Investment · ระบบสนับสนุนการตัดสินใจลงทุนด้วย AI ภายใต้การกำกับของมนุษย์<br/>ข้อมูลตลาดอาจล่าช้า ควรตรวจสอบข้อมูลก่อนส่งคำสั่งลงทุนจริง</> : <>Sentinel Investment · AI-powered institutional decision support with human oversight.<br/>Market data may be delayed; validate execution decisions independently.</>}
      </div>
    </div>
  );
}
