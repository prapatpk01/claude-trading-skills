...
import CIOCommandCenterV35 from "./components/CIOCommandCenterV35";
...
export default function Home() {
  ...
  return (
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="35.0" data-forecast-version="26.1" data-technical-version="34.1" data-research-version="32" data-architecture="unified-cio-command-path" data-source-of-truth="portfolio-ledger">
      ...
      <footer className="footer-note v11-footer">Sentinel Investment OS V35 · Research V32 · Technical V34.1 · Forecast V26.1 · STATUS → OPPORTUNITIES → PORTFOLIO → CAPITAL → CIO DECISION · Human approval remains mandatory · No automatic execution.</footer>
    </div>
  );
}
