...
export default function Home(){
 ...
 return <div className="sentinel-shell" data-sentinel-version="10.4" data-governance="committee-state-machine" data-source-of-truth="ledger">
  ...
  <div className="footer-note">{lang==="th"?<>Sentinel Investment OS v10.4 · Multi-Factor Alpha Discovery, Committee State Machine และ Ledger Single Source of Truth ภายใต้การกำกับของมนุษย์<br/>ผลสแกนส่งเข้า Watchlist และ Research ก่อนเข้าสู่มติประชุมและ Trade Ticket ที่มนุษย์อนุมัติ</>:<>Sentinel Investment OS v10.4 · Multi-Factor Alpha Discovery, Committee State Machine and ledger-based single source of truth with mandatory human oversight.<br/>Scanner results flow to Watchlist and Research before committee resolution and human-approved trade tickets.</>}</div>
 </div>
}
