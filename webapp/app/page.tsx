...
import CIOCommandCenterV17 from "./components/CIOCommandCenterV17";
...
export default function Home() {
  ...
  return (
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="17.0" data-architecture="professional-fund-committee" data-source-of-truth="portfolio-ledger">
      <header className="sentinel-topbar v11-topbar">
        <div className="sentinel-brand-lockup" aria-label="Sentinel Investment">
          ...
          <div className="sentinel-wordmark"><strong>SENTINEL</strong><strong>INVESTMENT OS</strong><span>Institutional Fund Operating System v17</span></div>
        </div>
      ...
      <div className="institutional-layout v11-layout">
        ...
        <div className="institutional-content">
          ...
          <main className="sentinel-main v11-main">
            ...
            {section === "command" && <div className="workspace-stack" data-workspace="cio-v17"><CIOCommandCenterV17 lang={lang} onNavigate={navigate} /><CIOScenarioLabV13 lang={lang} /></div>}
      ...
      <footer className="footer-note v11-footer">Sentinel Investment OS v17 · Professional Committee → Valuation → Risk → Capital Routing → Human Approval · No automatic execution.</footer>
    </div>
  );
}
