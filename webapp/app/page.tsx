...
export default function Home(){
 ...
 return <div className="sentinel-shell" data-sentinel-version="10.5" data-governance="adaptive-portfolio-committee" data-source-of-truth="ledger-and-meeting-memory">
  ...
  <div className="footer-note">{lang==="th"?<>Sentinel Investment OS v10.5 · Adaptive Portfolio Committee, Multi-Asset Resolution, Planned-vs-Actual Reconciliation และ Tiered Meeting Memory<br/>ระบบยอมรับยอดซื้อขายจริงที่ต่างไม่เกิน ±10% เป็นฐานใหม่ เก็บมติและ Thesis แบบถาวรย่อ และลบรายละเอียดชั่วคราวตามอายุข้อมูล</>:<>Sentinel Investment OS v10.5 · Adaptive Portfolio Committee, multi-asset resolution, planned-vs-actual reconciliation and tiered meeting memory.<br/>Actual fills within ±10% become the next baseline; compact resolutions and active thesis persist while temporary working detail expires.</>}</div>
 </div>
}
