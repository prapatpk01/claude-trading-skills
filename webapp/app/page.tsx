    ...
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="20.0" data-architecture="decision-execution-command-center" data-source-of-truth="portfolio-ledger">
      <header className="sentinel-topbar v11-topbar">
        <div className="sentinel-brand-lockup" aria-label="Sentinel Investment">
          ...
          <div className="sentinel-wordmark"><strong>SENTINEL</strong><strong>INVESTMENT OS</strong><span>Decision &amp; Execution Fund OS v20</span></div>
        </div>
      ...
      <div className="institutional-layout v11-layout">
        ...
        <div className="institutional-content">
          ...
          <main className="sentinel-main v11-main">
            ...
            {section === "command" && <div className="workspace-stack" data-workspace="cio-v20"><CIOCommandCenterV20 lang={lang} onNavigate={navigate} /></div>}
