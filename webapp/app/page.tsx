...
export default function Home(){
 ...
 return <div className="sentinel-shell" data-sentinel-version="10.4" data-governance="committee-state-machine" data-source-of-truth="ledger">
  ...
  <div className="footer-note">{lang==="th"?<>Sentinel Investment OS v10.4 · Holdings Intelligence รวมอยู่ในการประชุม, Multi-Factor Alpha Discovery และ Ledger Single Source of Truth ภายใต้การกำกับของมนุษย์<br/>Portfolio Team รายงานสถานะ Holdings เท่านั้น ส่วนคำสั่งซื้อขายต้องมาจาก Committee Resolution และ Trade Ticket ที่มนุษย์อนุมัติ</>:<>Sentinel Investment OS v10.4 · Holdings Intelligence inside the committee, Multi-Factor Alpha Discovery and ledger-based single source of truth with mandatory human oversight.<br/>The Portfolio Team reports holding status only; every trade must originate from a committee resolution and a human-approved trade ticket.</>}</div>
 </div>
}
