...
export default function Home() {
  ...
  return (
    <div className="sentinel-shell sentinel-v12" data-sentinel-version="12.3" data-architecture="domain-workspaces" data-source-of-truth="portfolio-ledger">
      <header className="sentinel-topbar v11-topbar">
        <div className="sentinel-brand-lockup" aria-label="Sentinel Investment">
          ...
          <div className="sentinel-wordmark"><strong>SENTINEL</strong><strong>INVESTMENT OS</strong><span>Institutional Fund Operating System v12.3</span></div>
        </div>
      ...
      <footer className="footer-note v11-footer">Sentinel Investment OS v12.3 · Research → Stock Analysis → Holdings → CIO Committee · Human approval remains mandatory.</footer>
    </div>
  );
}
