...
export default function HoldingsMarketMonitor({ onUpdated }: { onUpdated?: () => void }) {
  ...
  return <div className="card holdings-monitor-card" data-feature="holding-reconciliation ledger-edit-actions multi-range-chart">
    <div className="holdings-monitor-head">
      <div><h2 className="section" style={{ margin: 0 }}>📈 Portfolio & Watchlist Market Monitor</h2><p className="muted" style={{ fontSize: 12, marginTop: 6 }}>Sentinel X sets trend and technical targets; MCDX confirms accumulation/distribution. Weekly decides, Daily times execution.</p></div>
