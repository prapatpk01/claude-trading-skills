...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      ...
      brokerUsdCash: snapshot.investmentCash,
      dividendCash: snapshot.dividendAvailable,
      liquidCash: snapshot.liquidCash,
      reserveMarketValue: snapshot.reserveMarketValue,
      reserveLiquidityValue: snapshot.reserveLiquidityValue,
      reserveHoldings: snapshot.reserveHoldings,
      totalReserveAssets: snapshot.totalReserveAssets,
      riskAdjustedLiquidityBuffer: snapshot.riskAdjustedLiquidityBuffer,
